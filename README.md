...
| [Newsletter signup + email preferences](docs/features/email-preferences.md) | ✅ Shipped | Footer signup, welcome + welcome-back emails, Resend Audience sync, opaque server-stored unsubscribe tokens, tokenless unsubscribe confirmation redirect, account-managed email preferences, email-link preferences page, rate limiting, and PostHog events | —                                                            |
